...
public class SolutionsRepository {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger( SolutionsRepository.class.getName() );
    ...
    @Autowired
    public SolutionsRepository(JdbcTemplate jdbcTemplate, ServerConfiguration configuration) {
