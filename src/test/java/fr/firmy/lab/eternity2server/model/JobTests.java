...
public class JobTests {
    ...
    @Test
    @Deprecated
    public void test_job_from_description_1() throws MalformedJobDescriptionException {
        JobDescription description = new JobDescription( new BoardDescription("$.:.:.:.:.:.:.:.:.:;") );
    ...
    @Test
    @Deprecated
    public void test_job_from_description_2() throws MalformedJobDescriptionException {
        JobDescription description = new JobDescription( new BoardDescription( "$212W:203S:.:.:.:.:.:.:.:;") );
        Job job = jobAdapter.fromDescription(description);
        assertThat(jobAdapter.toDescription(job).getJob().getRepresentation()).as("Full Job description").isEqualTo(description.getJob().getRepresentation());
    }
    ...
    @Test
    public void test_job_is_done_1() {
        Job job = testDataHelper.buildJob("$212W:.:.:.:.:.:203S:.:.:;");
        assertThat(job.isDone()).as("Job is done").isFalse();
    }

    @Test
    public void test_job_is_done_2() {
        Job job = testDataHelper.buildJob("$212W:.:.:.:.:.:203S:.:.:;");
        assertThat(job.isDone()).as("Job is done").isFalse();
    }
